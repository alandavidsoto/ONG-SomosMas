      ...
      >
        {matchMobile && (
          <Box sx={{ width: "55px" }}>
            <img
              style={{ width: "100%" }}
              src="https://res.cloudinary.com/dcea83ydd/image/upload/v1635056516/carpeta%20de%20pruebas%28%20no%20importante%29/Logotipo_campa%C3%B1a_juguetes_saltko.png"
            />
          </Box>
        )}
...
export default LandingHeaderJuguetes;
